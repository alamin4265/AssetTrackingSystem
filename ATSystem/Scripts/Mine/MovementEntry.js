...
function GetAssetInfoByAssetId(assetId) {
    ...
    $.ajax({
        type: "POST",
        url: "/JsonLoader/GetAssetDetailsWithAllNameById",
        ...
        success: function (data) {
            ...
            if (data == "NotFound") {
                ...
                document.getElementById("BrandName").value = data;
                document.getElementById("CategoryNme").value = data;
                document.getElementById("GeneralCategoryName").value = data;
                document.getElementById("OrganizationName").value = data;
                document.getElementById("BranchName").value = data;
            }
            else {
                document.getElementById("Code").value = data.Code;
                document.getElementById("SerialNo").value = data.SerialNo;
                document.getElementById("BrandName").value = data.BrandName;
                document.getElementById("CategoryNme").value = data.CategoryName;
                document.getElementById("GeneralCategoryName").value = data.GeneralCategoryName;
